...
```
java -jar dominion-ecs-examples/target/dominion-ecs-examples-0.7.0-SNAPSHOT.jar
```
...
```
java -cp dominion-ecs-examples/target/dominion-ecs-examples-0.7.0-SNAPSHOT.jar dev.dominion.ecs.examples.dark.DarkEntities
```
