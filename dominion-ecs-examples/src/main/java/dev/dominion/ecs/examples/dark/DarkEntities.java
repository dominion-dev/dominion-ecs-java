 ...
 * Implements a neat lighting system able to fork subsystems and distribute to worker threads to take advantage of multiple
 * cores.
 */
public final class DarkEntities {

    // don't print Dominion banner info at startup
    static {
